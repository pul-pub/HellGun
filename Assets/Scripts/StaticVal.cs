...
public static class StaticVal
{
    ...
    public static Gun[] gun = {new Gun("AKM",       0, 12f, 30, 0.075f, false, 1f,   30, new Vector3(-0.54f,  -0.77f, 0)),
                               new Gun("VAL",    3200, 25f, 14, 0.05f,  false, 0.5f, 14, new Vector3(-0.54f, -0.73f, 0)),
                               new Gun("AK-108", 2000, 18f, 42, 0.08f,  false, 1.9f, 42, new Vector3(-0.543f, -0.79f, 0)),
                               new Gun("M-16",   4000, 20f, 30, 0.05f,  false, 0.9f, 30, new Vector3(-0.525f,  -0.8f, 0)),
                               new Gun("FAL",    6850, 30f, 24, 0.08f,  false, 1.3f, 24, new Vector3(-0.54f,  -0.75f, 0)) };
}
